...
export const roleBenefits = [
  ...
  { icon: Store, label: 'Owners', title: 'Complete oversight', description: 'Manage operations, inventory, people, settings, and performance.' },
]
...
export const faqs = [
  ...
  { question: 'Can customers choose pickup instead of delivery?', answer: 'Yes. Choose store pickup or local delivery during checkout. Payment is arranged with the store.' },
