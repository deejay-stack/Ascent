  ...
  return (
    <div className="operations-page">
      ...
      <div className="data-table-wrap">
        ...
        {!products.length && <p className="pos-empty">{all.length ? 'No matching inventory. Try another search or filter.' : user.role === 'owner' ? 'Your inventory is empty. Add a category, then create your first product with a photo, price and opening stock.' : 'No products yet. Ask the owner to add the available products.'}</p>}
      </div>
