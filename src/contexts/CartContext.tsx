...
const key='ascent-grocery-cart-v1'
...
export function CartProvider({children}:{children:ReactNode}) {
  ...
  const value=useMemo(()=>({items,itemCount,addItem,setQuantity,removeItem,clearCart}),[items,itemCount,addItem,setQuantity,removeItem,clearCart])
