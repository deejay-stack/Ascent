    ...
    <section className="operations-page">
      <header className="operations-heading">
        <div>
          ...
          <p>Local orders reserve stock. Sales reports update after payment is recorded.</p>
        </div>
        {user.role === 'customer' && (
      ...
      {confirm && (
        <Modal title="Record order payment" onClose={() => setConfirm(null)}>
          <p>
            Confirm that exact cash of <strong>{money(confirm.total)}</strong> was received for this
            local demonstration order. Stock was reserved at checkout.
          </p>
