...
export function RoleDashboardPage({ role }: { role: UserRole }) {
  ...
  return (
    <div className="operations-page">
      <header className="operations-heading">
        <div>
          <p className="eyebrow">Today's overview · Local records</p>
